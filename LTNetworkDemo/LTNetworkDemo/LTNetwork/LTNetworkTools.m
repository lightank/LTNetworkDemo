...
{
    [[self currentViewController] presentViewController:[self alertControllerForNetwork] animated:YES completion:^{
...
{
    if (![[self currentViewController] isKindOfClass:[UITapGestureRecognizer class]])
    {
        [[self currentViewController] presentViewController:[self alertControllerForNetwork] animated:YES completion:^{
...
{
    UIViewController *rootViewController = (([UIApplication sharedApplication].keyWindow) ? : ([UIApplication sharedApplication].delegate.window)).rootViewController;
    while ([rootViewController presentedViewController]) rootViewController = [rootViewController presentedViewController];
    while ([rootViewController isKindOfClass:[UINavigationController class]] && [(UINavigationController*)rootViewController topViewController])
